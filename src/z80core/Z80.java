 ...
 * 
 *          06/06/2011 Pequeńas optimizaciones en LDI/LDD y CPI/CPD. Se eliminan
 ...
 * 
 *          04/07/2011 Se elimina el método push ańadido el 28/03/2010 y se usa
...
public class Z80 {
     ...
     *
     * 25/09/2009     Se ha completado la emulación de MEMPTR. A seńalar que
    ...
    // Los 4 bits superiores de A no se tocan. ˇp'habernos matao!
    private void rrd() {
        int aux = (regA & 0x0f) << 4;
        memptr = getRegHL();
